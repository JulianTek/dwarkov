	...
	public class Light2DEditor : Editor
	{
		...
		private bool OnScene_FreeForm()
		{
			...
			for(int i = 0; i < points.Count; i++)
			{
				...
				var fmh_201_52_638368578448591508 = Quaternion.identity; Vector3 result = Handles.FreeMoveHandle(point, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
		...
		private bool OnScene_Point()
		{
			...
			var fmh_255_51_638368578448678622 = Quaternion.identity; Vector3 result = Handles.FreeMoveHandle(point, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
			...
			var fmh_298_61_638368578448694118 = Quaternion.identity; Vector3 innerHandle = Handles.FreeMoveHandle(innerPoint, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
			...
			if (light2D.spotAngleInner < 360)
			{
				...
				var fmh_336_70_638368578448712985 = Quaternion.identity; Vector3 outerHandleLeft = Handles.FreeMoveHandle(outerPointLeft, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
				...
				var fmh_362_72_638368578448725112 = Quaternion.identity; Vector3 outerHandleRight = Handles.FreeMoveHandle(outerPointRight, 0.05f * cameraSize, Vector2.zero, Handles.CylinderHandleCap);
